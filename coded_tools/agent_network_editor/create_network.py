...
class CreateNetwork(CodedTool):
    ...
    async def async_invoke(self, args: Dict[str, Any], sly_data: Dict[str, Any]) -> Union[Dict[str, Any], str]:
        ...
        :return: String indicating that a new network has been created and is ready to add agents.
        """
        sly_data[AGENT_NETWORK_NAME] = {}
        logger = logging.getLogger(self.__class__.__name__)
        logger.info(">>>>>>>>>>>>>>>>>>>Creating New Agent Netwrok!!!>>>>>>>>>>>>>>>>>>")
        return "New agent network created and ready to add agents."
