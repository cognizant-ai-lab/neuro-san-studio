...
class AddAgent(CodedTool):
    ...
    async def async_invoke(self, args: Dict[str, Any], sly_data: Dict[str, Any]) -> Union[Dict[str, Any], str]:
        ...
        the_agent_network_str = self.add_agent(the_agent_name, the_instructions, the_top_agent)
    ...
    def add_agent(self, agent_name: str, instructions: str, top_agent: bool) -> str:
        """
