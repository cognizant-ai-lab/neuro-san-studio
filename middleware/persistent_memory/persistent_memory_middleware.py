...
class PersistentMemoryMiddleware(AgentMiddleware):
    ...
    def build_preamble(cls) -> str:
        ...
        return (
            ...
            "- When you need memory: call 'list' to see cached intents, then decide which "
            "topic to read using your own judgment — do not call any tool for matching.\n"
            "- Prefer generalizing one memory over creating more.\n"
            "- To update an intent: 'delete' it first, then 'create' it fresh."
        )
