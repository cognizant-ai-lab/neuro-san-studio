...
* [Enterprise IT Service Desk Auto-Classifier](https://github.com/Sivakumarraj/antigravity-service-desk):
  A native 4-agent Neuro SAN pipeline that automatically classifies IT support requests into
  structured ServiceNow incident payloads using 5-pass PII redaction and `gemini-2.5-flash`.
