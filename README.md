...
* [Enterprise IT Service Desk Auto-Classifier Pipeline](https://github.com/Sivakumarraj/antigravity-service-desk) - A resilient multi-agent service automation system built using the `uv` toolchain, featuring declarative HOCON vendor-fallback logic chains and strict Pydantic v2 data self-healing guardrails.
