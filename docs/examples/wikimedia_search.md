...
A CodedTool implementation defined in [wikimedia_media_search.py](../../neuro_san_studio/coded_tools/tools/wikimedia_media_search.py) that searches Wikimedia Commons for media files.
