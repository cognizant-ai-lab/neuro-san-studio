...
class TestNowAgentAPIGetAgents(unittest.TestCase):
    ...
    @patch("neuro_san_studio.coded_tools.tools.now_agents.nowagent_api_get_agents.requests.get")
    ...
    @patch("neuro_san_studio.coded_tools.tools.now_agents.nowagent_api_get_agents.requests.get")
    @patch("neuro_san_studio.coded_tools.tools.now_agents.nowagent_api_get_agents.logger")
