...
class TestNowAgentRetrieveMessage(unittest.TestCase):
    ...
    @patch("neuro_san_studio.coded_tools.tools.now_agents.nowagent_api_retrieve_message.requests.get")
    ...
    @patch("neuro_san_studio.coded_tools.tools.now_agents.nowagent_api_retrieve_message.requests.get")
    @patch("neuro_san_studio.coded_tools.tools.now_agents.nowagent_api_retrieve_message.time.sleep")
