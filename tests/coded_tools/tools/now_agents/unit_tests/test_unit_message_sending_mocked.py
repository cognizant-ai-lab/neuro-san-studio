...
class TestNowAgentSendMessage(unittest.TestCase):
    ...
    @patch("neuro_san_studio.coded_tools.tools.now_agents.nowagent_api_send_message.requests.post")
    ...
    @patch("neuro_san_studio.coded_tools.tools.now_agents.nowagent_api_send_message.requests.post")
    @patch("neuro_san_studio.coded_tools.tools.now_agents.nowagent_api_send_message.logger")
