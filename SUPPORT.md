...
**Note**: This project is licensed under the [Apache 2.0 License](LICENSE), which requires a commercial license for for-profit use. Please contact us to discuss commercial licensing options.
